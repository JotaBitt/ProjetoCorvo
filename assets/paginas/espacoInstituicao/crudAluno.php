    ...
    .materia-title {
     ...
     <!-- <script>
       ...
       function inserirAluno() {
           ...
           let objForm2 ={"nome":nome,"matricula":matricula,"datadenascimento":datadenascimento,"email":email,"cpf":cpf,"sexo":sexo};
           let xmlhttp = new XMLHttpRequest();
           xmlhttp.onreadystatechange = function() {
               if (this.readyState == 4 && this.status == 200) {
           ...
           xmlhttp.open("POST", "incluirAluno.php");
           xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
           xmlhttp.send("nome="+nome + "&matricula="+matricula + "&datadenascimento="+datadenascimento  + "&email="+email + "&cpf="+cpf + "&sexo="+sexo);
       }
        ...
        function CriarLinhaTabela(pobjReturnJSON) {
          ...
          textnode = document.createTextNode(pobjReturnJSON.usuario);
          td2.appendChild(textnode); 
          tr.appendChild(td3);
          ...
          textnode = document.createTextNode(pobjReturnJSON.status);
          td2.appendChild(textnode); 
          tr.appendChild(td6);
