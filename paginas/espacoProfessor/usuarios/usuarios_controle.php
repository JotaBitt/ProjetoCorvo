...
<head>
    ...
    <title>Controle de Usuários - Corvo</title>
</head>
    ...
    <main class="container mt-4">
        ...
        <div class="card mb-4 p-5">
            <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                <h2 class="h4">Controle de Usuários</h2>
                <div>
                ...
                <tbody>
                    ...
                    foreach ($alunos as $aluno) {
                        ...
                        if ($verificarProfessor) {
                            ...
                            echo "<td>";
                            echo "<a href='{$link}/turmas/{$turma['idTurma']}/alunos/{$aluno['matricula']}' class='btn btn-primary'><i class='fa-solid fa-eye'></i></a>";
                            echo "</td>";
                        }
                        echo "</tr>";
                    }
