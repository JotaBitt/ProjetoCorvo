...
<head>
  ...
  <script>
    ...
    function adicionarProfessor() {
      ...
      xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
      xmlhttp.send("cpf=" + cpfAd + "&nome=" + nomeAd + "&email=" + emailAd + "&telefone=" + telefoneAd + "&data_nascimento=" + data_nascimentoAd + "&data_contratacao=" + data_contratacaoAd);
    }
    ...
    function excluirProfessores(matricula) {
      let xmlhttp = new XMLHttpRequest();
      xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
    ...
    function CriarLinhaTabela(professor) {
      ...
      btnExcluir.addEventListener("click", function() {
        excluirProfessores(professor.matricula);
      });
