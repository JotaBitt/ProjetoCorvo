  ...
  <?php include '../../assets/includes/head.php'; ?>
    ...
    <script>
        ...
        function adicionarAluno() {
            ...
            xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xmlhttp.send(`cpf=${cpfAd}&nome=${nomeAd}&email=${emailAd}&telefone=${telefoneAd}&data_nascimento=${data_nascimentoAd}`);
        ...
        function CriarLinhaTabela(pobjReturnJSON) {
            ...
            btnExcluir.addEventListener("click", function() {
                excluirAlunos(pobjReturnJSON.matricula);
            });
    ...
    <div class="container">
        ...
        <div class="mt-4">
            ...
            <form id="formAlterar" class="formulario" style="display: none;">
                ...
                <input type="text" id="matricula" name="matricula" class="form-control mb-2" readonly>
                <label for="cpf">CPF:</label>
                <input type="text" id="cpf" name="cpf" class="form-control mb-2" >
