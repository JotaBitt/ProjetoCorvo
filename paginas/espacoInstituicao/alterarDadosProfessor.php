<?php
    ...
    $comandoSQL = "UPDATE corvo_professor SET nome='$nome', cpf='$cpf', matricula='$matricula', email='$email', telefone='$telefone', data_nascimento='$data_nascimento', data_contratacao='$data_contratacao' WHERE matricula='$matricula'";
