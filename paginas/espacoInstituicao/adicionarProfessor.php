<?php
    ...
    $comandoSQL_insert_professor= "INSERT INTO `corvo_professor`(`id`, `nome`, `email`, `cpf`, `telefone`, `matricula`, `data_nascimento`, `data_contratacao`) VALUES ('$idUsuario','$nomeCompleto','$email','$cpf','$telefone','$matricula','$data_nascimento', '$data_contratacao')";
    $resultado = $conn->query($comandoSQL_insert_professor);
    $retorno=json_encode($resultado);
    echo $retorno;
    ...
    $comandoSQL_insert_usuario_funcao = "INSERT INTO `corvo_usuarios_funcao`(`id`, `matricula`, `aluno`, `professor`, `adm`) VALUES ('$idUsuario','$matricula','0','1','0')";
